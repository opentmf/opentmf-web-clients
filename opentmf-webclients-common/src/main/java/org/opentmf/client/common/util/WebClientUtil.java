...
public final class WebClientUtil {
  ...
  public static Mono<Throwable> handleError(ClientResponse clientResponse,
      Class<? extends OpenTmfWebClientException> exceptionClass) {
  ...
  private static OpenTmfWebClientException createException(
      HttpStatusCode httpStatusCode, Class<? extends OpenTmfWebClientException> exception) {
    try {
  ...
  private static OpenTmfWebClientException createException(
      HttpStatusCode httpStatusCode, String message, Class<? extends OpenTmfWebClientException> exception) {
    try {
      return exception
  ...
  public static boolean shouldRetryOn(Throwable throwable) {
    ...
    if (throwable instanceof OpenTmfWebClientException e) {
